    ...
    public partial class siteInfoDataSet : global::System.Data.DataSet {
        ...
        public partial class sitesDataTable : global::System.Data.DataTable, global::System.Collections.IEnumerable {
            ...
            public sitesRow AddsitesRow(
                        ...
                        double Latitude, 
                        double Longitude, 
                        SpatialReferencesRow parentSpatialReferencesRowByFK_Sites_SpatialReferences, 
                        string VerticalDatum, 
                        double LocalX, 
                        double LocalY, 
                        SpatialReferencesRow parentSpatialReferencesRowBySites_FK01, 
                        string State, 
                        string County, 
                        string Comments, 
                        double Elevation_m, 
...
namespace WaterOneFlow.odm.v1_1.siteInfoDataSetTableAdapters {
    ...
    public partial class sitesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = @"SELECT        SiteID, SiteCode, SiteName, Latitude, Longitude, LatLongDatumID, Elevation_m, VerticalDatum, LocalX, LocalY, LocalProjectionID, PosAccuracy_m, State, County, 
                         Comments, SiteType
FROM            Sites
WHERE        (Latitude BETWEEN @SOUTH AND @NORTH) AND (Longitude BETWEEN @WEST AND @EAST)";
            ...
            this._commandCollection[2].CommandText = @"SELECT        Comments, County, Elevation_m, LatLongDatumID, Latitude, LocalProjectionID, LocalX, LocalY, Longitude, PosAccuracy_m, SiteCode, SiteID, SiteName, State, 
...
WHERE        (SiteCode = @SiteCode)";
            ...
            this._commandCollection[3].CommandText = @"SELECT        Sites.Comments, Sites.County, Sites.Elevation_m, Sites.LatLongDatumID, Sites.Latitude, Sites.LocalProjectionID, Sites.LocalX, Sites.LocalY, Sites.Longitude, 
