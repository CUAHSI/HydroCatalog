...
namespace WaterOneFlow.odm.v1_1.seriesCatalogDataSetTableAdapters {
    ...
    public partial class SeriesCatalogTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = @"SELECT        SeriesID, SiteID, SiteCode, SiteName, VariableID, VariableName, VariableCode, VariableUnitsName, VariableUnitsID, SampleMedium, ValueType, GeneralCategory, 
                         BeginDateTime, EndDateTime, ValueCount, MethodID, MethodDescription, QualityControlLevelID, BeginDateTimeUTC, EndDateTimeUTC, SourceID, Organization, 
                         SourceDescription, Speciation, TimeSupport, TimeUnitsName, DataType, TimeUnitsID, QualityControlLevelCode, Citation, SiteType
FROM            SeriesCatalog";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = @"SELECT        BeginDateTime, BeginDateTimeUTC, Citation, DataType, EndDateTime, EndDateTimeUTC, GeneralCategory, MethodDescription, MethodID, Organization, 
                         QualityControlLevelCode, QualityControlLevelID, SampleMedium, SeriesID, SiteCode, SiteID, SiteName, SourceDescription, SourceID, Speciation, TimeSupport, 
                         TimeUnitsID, TimeUnitsName, ValueCount, ValueType, VariableCode, VariableID, VariableName, VariableUnitsID, VariableUnitsName, SiteType
FROM            SeriesCatalog
WHERE        (SiteID = @siteID)";
