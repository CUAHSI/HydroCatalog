...
namespace WaterOneFlow.odws
{
    ...
    namespace v1_0.wcf
    {
        ...
        [ServiceBehavior(Namespace = ConstantsNs.WS_NAMSPACE
            ...
            //ConcurrencyMode = ConcurrencyMode.Single //http://stackoverflow.com/questions/4767102/wcf-sessions-with-a-wshttpbinding-and-without-windows-security
           , AddressFilterMode = AddressFilterMode.Any //Using this value turns off the address filter check. Any message, no matter what its WS-Adressing:To identity is accepted.
           )]
