...
namespace cuahsi.his.service.xslt
{
    namespace v1_0
    {
      ...
      //  using WaterOneFlow.Schema.v1_0;
       // using WaterOneFlow.odws;
       public class TransformSites
        {
           ...
           private static ILog log = LogManager.GetLogger(typeof(TransformSites));
            ...
            private GetSiteInfoOD svc;

            private CompiledXslt xslt;
            private string xsltName;
            public TransformSites()
                : base()
            {
            ...
            public TransformSites(string XlstName)
                : base()
            {
...
ElementName = "siteResponse",
   IsNullable = false
                // , Type = typeof(SiteInfoResponseType)
     )]
       ...
       string Location
        )
            {
                ...
                try
                {
                    ...
                    locationParam s = new locationParam(Location);
                   var result = svc.GetSiteInfoResponse(s);
                    // var result = svc.GetSiteInfo(s);
