...
public partial class _Default : System.Web.UI.Page 
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        SqlDataSource2.SelectCommand="select altvariablename, conceptID, m.variableID from mappingsapproved as m join variables as v on v.variableid=m.variableID WHERE "+sourceString+" order by datemapped desc";
