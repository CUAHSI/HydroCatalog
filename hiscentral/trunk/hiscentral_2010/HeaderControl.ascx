<%@ Control Language="C#" AutoEventWireup="true" Inherits="WebUserControl" Codebehind="HeaderControl.ascx.cs" %>
...
<asp:LoginView ID="LoginView1" runat="server" OnViewChanged="LoginView1_ViewChanged"  >
    <LoggedInTemplate>
        ...
        <asp:LoginName ID="LoginName1" runat="server" Font-Bold="True" FormatString="Welcome, {0}"
            Style="z-index: 100; left: 658px; position: absolute; top: 11px" Width="218px" ForeColor="White" TabIndex="-1" />
        <asp:LinkButton ID="LinkButton1" runat="server" Font-Bold="False" Font-Size="Smaller"
            ...
            top: 31px" Width="52px" OnClick="LinkButton1_Click" ForeColor="White" TabIndex="-1">Log out</asp:LinkButton>
      &nbsp;
        <asp:HyperLink ID="HyperLink1" runat="server" BorderStyle="None" Font-Bold="True"
            ...
            position: absolute; top: 110px" Width="125px" Font-Size="Smaller" ForeColor="White" TabIndex="-1">Add Data Service</asp:HyperLink>
        ...
        <asp:HyperLink ID="HyperLink3" runat="server" BorderStyle="None" Font-Bold="True"
            ...
            position: absolute; top: 110px" Width="124px" Font-Size="Smaller" ForeColor="White" TabIndex="-1">My Data Services</asp:HyperLink>
        <asp:HyperLink ID="HyperLink5" runat="server" BorderStyle="None" Font-Bold="True"
            ...
            position: absolute; top: 110px" Width="115px" Font-Size="Smaller" ForeColor="White" TabIndex="-1">All Data Services</asp:HyperLink>    
    </LoggedInTemplate>
    <AnonymousTemplate>
<asp:HyperLink ID="HyperLink7" runat="server" BorderStyle="None" Font-Bold="True"
            Font-Size="Smaller" Font-Underline="False" ForeColor="White" NavigateUrl="default.aspx"
    ...
    <RoleGroups>
        ...
        <asp:LinkButton ID="LinkButton1" runat="server" Font-Bold="False" Font-Size="Smaller"
            ...
            top: 29px" Width="87px" OnClick="LinkButton1_Click" ForeColor="White" TabIndex="-1">Log out</asp:LinkButton>
        <asp:HyperLink ID="HyperLink1" runat="server" BorderStyle="None" Font-Bold="True"
        ...
        <asp:HyperLink ID="HyperLink5" runat="server" BorderStyle="None" Font-Bold="True"
            ...
            position: absolute; top: 110px" Width="136px" Font-Size="Smaller" ForeColor="White" TabIndex="-1">All Data Services</asp:HyperLink>    
        <asp:HyperLink ID="HyperLink6" runat="server" BorderStyle="None" Font-Bold="True"
            Font-Underline="False" NavigateUrl="admin/admin.aspx" Style="z-index: 106; left: 674px;
            position: absolute; top: 65px" Width="102px" Font-Size="Smaller" ForeColor="White" TabIndex="-1">Administration</asp:HyperLink>
        </ContentTemplate>
        </asp:RoleGroup>
    </RoleGroups>
</asp:LoginView>
