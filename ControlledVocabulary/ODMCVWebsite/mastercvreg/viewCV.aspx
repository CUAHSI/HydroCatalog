...
<%@ Page Language="vb" AutoEventWireup="false" Inherits="MCVReg.viewCV" CodeFile="viewCV.aspx.vb" %>
		...
		<form id="Form1" method="post" runat="server">
			<asp:panel id="pnlMsg" Visible="False" Runat="server">
				...
				<asp:Panel id="pnlReturn" Runat="server" Visible="False">
					<BR>
					<a href="admindefault.aspx">Return to Pending Controlled Vocabularies Submissions</a>
					<BR>
				</asp:Panel>
			</asp:panel>
				...
				<TABLE cellpadding="8">
					<TR>
						...
						<TD><asp:Label ID="lblHeader1" Runat="server"></asp:Label><br>
							<asp:TextBox id="txt1" Runat="server" Visible="False"  Width="300" ReadOnly="True"></asp:TextBox></TD>
					</TR>
					<TR>
						<TD valign="middle">
