...
<%@ Page Language="vb" AutoEventWireup="false" Inherits="MCVReg.edit_cv11" CodeFile="edit_cv11.aspx.vb" %>
...
<HTML>
	...
	<style>th, td {margin:8px; padding:8px; vertical-align:center;}</style>

		<form id="form1_11" runat="server">
			<asp:panel id="pnlMsg_11" Visible="False" Runat="server">
				<H4>
					<asp:Label id="lblMsg_11" Runat="server"></asp:Label></H4>
			...
			<asp:panel id="pnl1_11" Runat="server"><B><FONT>
				<h2><asp:Label id="lblTableName" Runat="server"></asp:Label></FONT></B></h2>
				<asp:button id="btnBack" Runat="server" Text="Back to CV Page"></asp:button>&nbsp;&nbsp;&nbsp;&nbsp; 
				<asp:dropdownlist id="ddlcv11" runat="server" AutoPostBack="True"></asp:dropdownlist><BR><br>
				<asp:label id="lblTableInformation" runat="server"></asp:label>
				<BR><BR>
				<asp:DataGrid id="dgCV_11" Runat="server" EnableViewState="True" OnItemCommand="dgCV_11_ItemCommand"
			...
			<asp:panel id="pnl2_11" Visible="False" Runat="server">
				<H2>
