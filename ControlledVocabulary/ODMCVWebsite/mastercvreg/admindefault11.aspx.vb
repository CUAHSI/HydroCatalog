...
#Region " Web Form Designer Generated Code "
    ...
    Private Sub Page_Init(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Init
        ...
        tableNames = OpenTable("ODMCV_1_1", "SELECT name, id FROM sysobjects " _
        ...
        If tableNames.Rows.Count > 0 Then
            For Each curRow In tableNames.Rows
                ...
                columnTable = OpenTable("ODMCV_1_1", "SELECT name FROM syscolumns WHERE id = " & CStr(curRow.Item(1)) _
                ...
                myTable = OpenTable("ODMCV_1_1", "SELECT " _
                    & "'<a href=" & Chr(34) & "viewCV11.aspx?act=' + action_flag + '&tbl=" _
