<%@ Page Language="vb" AutoEventWireup="false" Inherits="MCVReg.admindefault" CodeFile="admindefault.aspx.vb" %>
...
<HTML>
	...
	<body MS_POSITIONING="GridLayout">--->
		...
		<form id="Form1" method="post" runat="server">
			<h2>Pending Controlled Vocabulary Submissions &mdash; ODM Version 1.0</h2>
			...
			<a href="cv10.aspx">Return to Controlled Vocabulary Table list</a><br><br>
		</form>
