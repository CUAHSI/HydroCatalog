<%@ Page Language="C#" AutoEventWireup="true" Title="CUAHSI HIS | Master Controlled Vocabulary Registry | Administrator | ODM 1.1" CodeFile="manageCV11.aspx.cs" Inherits="manage_admin_manageCV" %>
...
<body>
    ...
    <h2>ODM 1.1 Controlled Vocabularies</h2>
    ...
    <div runat="server" id="AddContainer" visible="false">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            DeleteCommand="DELETE FROM [cv11] WHERE [id] = @id" 
            InsertCommand="INSERT INTO [cv11] ([id], [name], [description]) VALUES (@id, @name, @description)" 
            SelectCommand="SELECT [id], [name], [description] FROM [cv11] ORDER BY [name] " 
            UpdateCommand="UPDATE [cv11] SET [description] = @description WHERE [id] = @id">
            <DeleteParameters>
