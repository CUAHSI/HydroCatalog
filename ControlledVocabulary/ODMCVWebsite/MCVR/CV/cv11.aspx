<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/SiteMaster.master" Title="CUAHSI Hydrologic Information System - Master Controlled Vocabulary Registry" CodeFile="cv11.aspx.cs" Inherits="CV_cv11" %>
   ...
   <asp:GridView ID="CVList" runat="server" AutoGenerateColumns="False" DataSourceID="CVInfo" 
        ...
        <Columns>
            <asp:HyperLinkField DataTextField="name" DataNavigateUrlFields="id,name" 
                DataNavigateUrlFormatString="editcv11.aspx?id={0}&amp;tbl={1}&amp;type=&quot;cv11&quot;" />
     ...
     <asp:ObjectDataSource ID="CVInfo" runat="server" SelectMethod="GetCVInfo" 
         TypeName="GetCVs">
         <SelectParameters>
             <asp:Parameter DefaultValue="cv11" Name="type" Type="String" />
         </SelectParameters>
