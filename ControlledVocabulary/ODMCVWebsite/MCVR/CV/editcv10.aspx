<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/SiteMaster.master" CodeFile="editcv10.aspx.cs" Inherits="CV_editcv10" %>
...
<asp:Content ID="Content1"  runat="server" ContentPlaceHolderID="MainContent">
    <div style="min-height:460px;">
        ...
        <h2>Controlled Vocabulary for ODM 1.0</h2>
        ...
        <div id="CV10Display" runat="server" style="font-size: 14px;">        
            ...
            <asp:ObjectDataSource ID="cv10AccessDataSource" runat="server" 
                SelectMethod="GetCVContents" TypeName="cv10Access">
                <SelectParameters>
        ...
        <asp:HyperLink ID="BackLink" runat="server" NavigateUrl="~/CV/cv10.aspx">Back to Controlled Vocabulary Page</asp:HyperLink>
