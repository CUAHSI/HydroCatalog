...
namespace v1_1 {
 using ConstantsNs = Constants.v1_1;
    [WebServiceBinding(ConformsTo = WsiProfiles.BasicProfile1_1,
        Name = WsDescriptions.WsDefaultName,
   Namespace = ConstantsNs.ServiceDescriptions.WS_NAMSPACE)]
    interface IService
    {
        ...
        [SoapDocumentMethod(
      ResponseNamespace = ConstantsNs.ServiceDescriptions.XML_SCHEMA_NAMSPACE,
