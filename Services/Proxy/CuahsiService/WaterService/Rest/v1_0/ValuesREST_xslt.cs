...

{
    namespace v1_0
    {
        ...
        public class ValuesREST_xslt {
           
  

            private static ILog log = LogManager.GetLogger(typeof(ValuesREST_xslt));
            ...
            public ValuesREST_xslt(string BaseRestUrl)
                : base()
            {
            ...
            public ValuesREST_xslt(string BaseRestUrl,  string XlstName)
                : base()
            {
                RestBaseUrl = BaseRestUrl;
                xsltName = XlstName;
            ...
            private void InitializeService()
            {
                ...
                serializer = WOFXmlSerializerFactory.GetSerializer(typeof(TimeSeriesResponseString));
            }
...
ElementName = "timeSeriesResponse",
   IsNullable = false
            ...
            public TimeSeriesResponseString GetTimeSeries(
        ...
        W3CDateTime? BeginDateTime, W3CDateTime? EndDateTime)
            {
                ...
                try
                {
                    ...
                    using (WebClient web = new WebClient())
                    {
                        ...
                        var response
                            = (TimeSeriesResponseString)serializer.Deserialize(reader);
