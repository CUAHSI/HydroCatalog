...
namespace HisCentralServicesList
{
    public class HisSeriesList
    {
        ...
        */
        ...
        public static ObsSeriesServerList SeriesList()
        {
            var seriesList = new ObsSeriesServerList();
        ...
        public static ObsSeriesServerList  DisableSeries(ObsSeriesServerList originalList, ObsSeriesServerList newList)
        {
            ...
            {
                if (disabledOld.Contains(obs.Name))
                {
                    obs.Enabled = false;
                }
        ...
        public static IEnumerable<String> RemovedNetworks(ObsSeriesServerList originalList, ObsSeriesServerList newList)
        {
            
          var removedSeries = from o in originalList 
                              join n in newList on o.Name equals n.Name
                                  into outer 
                                      from n in outer.DefaultIfEmpty()
                                          select o.Name;
